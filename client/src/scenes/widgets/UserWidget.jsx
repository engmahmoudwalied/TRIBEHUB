...
const UserWidget = ({ userId, picturePath }) => {
  ...
  const currentUserId = useSelector((state) => state.user._id); // Add this line to get the logged-in user ID from the Redux store
    ...
    <WidgetWrapper sx={{ position: "sticky", top: 5, zIndex: 100 }}>
      ...
      <Box p="1rem 0">
        <Box display="flex" alignItems="center" gap="1rem" mb="0.5rem">
          ...
          />
          <Typography color={palette.neutral.dark}>{location}</Typography>
